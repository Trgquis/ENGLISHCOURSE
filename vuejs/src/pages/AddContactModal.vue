          ...
          <form  @submit.prevent="handleSubmit">
            ...
            <div class="mb-4">
              <label for="input" class="block text-gray-700 font-bold mb-2">
                ...
                <textarea id="message" name="message" v-model="message" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
