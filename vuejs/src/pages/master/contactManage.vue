            ...
            <div class="border border-gray-300 rounded-md p-[20px] h-full">
                ...
                <table style="table-layout: fixed; width: 100%;">
                    ...
                    <tr v-for="course in displayedCourse" :key="course.id">
                        ...
                        <td>
                            <textarea v-model="course.message" name="" id="" cols="30" rows="10"></textarea>
                        </td>
                        <td>
                            <button @click="editCourse(course)" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Edit</button>
                            <EditContactModalVue v-if="showModal" @close="showModal = false" :course="selectedCourse"/>
...
import AddContactModalVue from '../AddContactModal.vue';
export default {
    components: {
        Pagination,
        AddContactModalVue,
    ...
    methods: {
        ...
        // Make an HTTP DELETE request to delete the user
            try {
                ...
                const response = await axios.delete(`http://localhost:5000/contact/` + courseId);
