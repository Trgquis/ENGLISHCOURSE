      ...
      <div class="h-[50px] bg-gray-100 flex items-center shadow-sm px-[20px] w-full py-[10px] z-10 border-b ">
        ...
        <div class="w-[calc(100%-30px)] flex">
          <div class="w-[calc(100%-200px)] flex justify-center ">
            ...
            <button @click="AddUser()"  class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Add</button>
            <AddUserModal v-if="openModal" @close="openModal = false"/>
          </div>
          <!-- User login -->
            ...
            <div class="border border-gray-300 rounded-md p-[20px] h-full">
                ...
                <table style="table-layout: fixed; width: 100%;">
                    ...
                    <tr v-for="user in displayedUsers" :key="user.id">
                        ...
                        <td>{{ user.email }}</td>
                        <td>{{ user.gender }}</td>
                        <td style="text-center"><img :src="'http://localhost:5000/user/avatar/' + user._id" class="object-contain h-20 w-20 mx-auto" /></td>
                        <td>
                            <button @click="editUser(user)" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Edit</button>
                            <EditUserModal v-if="showModal" @close="showModal = false" :user="selectedUser"/>
                            <button @click="deleteUser(user)" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">Delete</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <pagination :data="displayedUsers" :limit="0" :current-page="currentPage" @page-change="onPageChange"></pagination>
            </div>
        </div>
    </div>
    <!-- Main  -->
